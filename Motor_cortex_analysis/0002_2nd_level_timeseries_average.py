if __name__ == '__main__':
    ...
    output_dir = '{0}/Motor_cortex_dgamma_5_smooth/Motor_cortex_activation_2nd_level_timeseries_OutputDir'.format(origin_dir)
    working_dir = '{0}/Motor_cortex_dgamma_5_smooth/Motor_cortex_activation_2nd_level_timeseries_WorkingDir'.format(origin_dir)
    ...
    # ============================================================================================================================
    # In[3]:
    infosource = Node(IdentityInterface(fields=['subject_id', 'session_id', 'BOLD_id', 'paw_id']),
                      name="infosource")
    ...
    templates_ts = {
        ...
        'ts_r1': 'Motor_cortex_dgamma_5_smooth/Motor_cortex_activation_1st_level_OutputDir/BOLD_timeseries/_run-1_{session_id}_sub-{subject_id}/{BOLD_id}_bold_{paw_id}_paw.txt',
        'ts_r2': 'Motor_cortex_dgamma_5_smooth/Motor_cortex_activation_1st_level_OutputDir/BOLD_timeseries/_run-2_{session_id}_sub-{subject_id}/{BOLD_id}_bold_{paw_id}_paw.txt',
        'ts_r3': 'Motor_cortex_dgamma_5_smooth/Motor_cortex_activation_1st_level_OutputDir/BOLD_timeseries/_run-3_{session_id}_sub-{subject_id}/{BOLD_id}_bold_{paw_id}_paw.txt',
        'ts_r4': 'Motor_cortex_dgamma_5_smooth/Motor_cortex_activation_1st_level_OutputDir/BOLD_timeseries/_run-4_{session_id}_sub-{subject_id}/{BOLD_id}_bold_{paw_id}_paw.txt',
