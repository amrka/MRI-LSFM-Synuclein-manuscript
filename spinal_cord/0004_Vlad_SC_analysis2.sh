...
Atlas=/Volumes/LSFM/straight_sc_ims/straightened_template/Atlas.nii.gz
working_dir=/Volumes/LSFM/SC_quant_lvl_0
output_dir_parent=/Volumes/LSFM/Vlad_SC_analysis_lvl_0
...
#        subj=$(basename $(dirname $(dirname "$img")))
        ...
        python /Users/aeed/Documents/Work/M83_clearing/Manuscript_analysis/LSFM_MRI/0009_spinal_cord/straighten_SC.py \
